...
1. `INT-058` (`FEAT-011`) to rename the tool and add Git extension invocation support.

## Sprintable Next Slice

1. `INT-058` (`FEAT-011`): rename CLI to `git-branch-tidy` and add compatibility invocation support.
